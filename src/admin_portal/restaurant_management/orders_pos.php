  ...
  <div id="orderDetailsModal" class="modal">
    <div class="modal-content p-6">
      ...
      <div class="flex gap-3 mt-6">
        <button onclick="closeModal('orderDetailsModal')" class="flex-1 border border-slate-200 py-2 rounded-lg hover:bg-slate-50">Close</button>
      </div>
    </div>
  </div>
  ...
  <div class="min-h-screen flex flex-col lg:flex-row">
    ...
    <aside class="lg:w-80 bg-white border-r border-slate-200 shadow-sm lg:min-h-screen shrink-0 overflow-y-auto">
      ...
      <nav class="p-4 space-y-2 text-sm">
        ...
        <!-- RESTAURANT MANAGEMENT GROUP - open with Orders / POS highlighted -->
        <details class="group" open>
          ...
          <div class="ml-6 mt-1 space-y-1 pl-3 border-l-2 border-amber-200">
            ...
            <a href="../restaurant_management/orders_pos.html" class="flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-100/50 text-amber-700 font-medium"><i class="fa-solid fa-cash-register w-4 text-amber-600"></i> Orders / POS</a>
        ...
        <details class="group" open>
          ...
          <div class="ml-6 mt-1 space-y-1 pl-3 border-l-2 border-amber-100">
            ...
            <a href="../operations/biling_and_payment.html" class="flex items-center gap-2 px-4 py-2 rounded-lg text-slate-600 hover:bg-amber-50"><i class="fa-regular fa-credit-card w-4"></i> Billing & Payments</a>
    ...
    <main class="flex-1 p-5 lg:p-8 overflow-y-auto bg-white">
      ...
      <div class="flex flex-wrap gap-2 border-b border-slate-200 pb-2 mb-6">
        <button id="filterAll" onclick="filterOrders('all', event)" class="filter-btn px-4 py-2 bg-amber-600 text-white rounded-full text-sm">all orders</button>
        <button id="filterDineIn" onclick="filterOrders('dine-in', event)" class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">dine-in</button>
        <button id="filterTakeout" onclick="filterOrders('takeout', event)" class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">take-out</button>
        <button id="filterDelivery" onclick="filterOrders('delivery', event)" class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">delivery</button>
        <button id="filterCompleted" onclick="filterOrders('completed', event)" class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">completed</button>
      </div>
      ...
      <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden mb-8">
        <div class="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
          ...
          <div class="flex gap-2">
            <button onclick="refreshOrders()" class="border border-slate-200 px-4 py-2 rounded-xl text-sm hover:bg-slate-50">
          ...
          <table class="w-full text-sm" id="ordersTable">
            ...
            <tbody class="divide-y" id="ordersTableBody">
              <tr data-order-id="OR1001" data-type="dine-in" data-status="preparing">
                ...
                <td class="p-3"><span class="type-badge bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs">dine-in</span></td>
                <td class="p-3">Table 4 · Cruz</td>
                <td class="p-3">3 items</td>
                <td class="p-3 font-medium">₱850</td>
                <td class="p-3"><span class="status-badge bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full text-xs">preparing</span></td>
                <td class="p-3">
                  <button onclick="viewOrder('OR1001')" class="text-amber-700 text-xs hover:underline mr-2">view</button>
                  <button onclick="updateOrderStatus('OR1001', 'ready')" class="text-green-600 text-xs hover:underline">ready</button>
                </td>
              </tr>
              <tr data-order-id="OR1002" data-type="takeout" data-status="preparing">
                ...
                <td class="p-3"><span class="type-badge bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs">take-out</span></td>
                <td class="p-3">Kim, Jiyeon</td>
                <td class="p-3">2 items</td>
                <td class="p-3 font-medium">₱540</td>
                <td class="p-3"><span class="status-badge bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full text-xs">preparing</span></td>
                <td class="p-3">
                  <button onclick="viewOrder('OR1002')" class="text-amber-700 text-xs hover:underline mr-2">view</button>
                  <button onclick="updateOrderStatus('OR1002', 'ready')" class="text-green-600 text-xs hover:underline">ready</button>
                </td>
              </tr>
              <tr data-order-id="OR1003" data-type="dine-in" data-status="served">
                ...
                <td class="p-3"><span class="status-badge bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs">served</span></td>
                <td class="p-3">
                  <button onclick="viewOrder('OR1003')" class="text-amber-700 text-xs hover:underline mr-2">view</button>
                  <button onclick="updateOrderStatus('OR1003', 'completed')" class="text-blue-600 text-xs hover:underline">payment</button>
                </td>
              </tr>
              <tr data-order-id="OR1004" data-type="delivery" data-status="preparing">
                ...
                <td class="p-3"><span class="type-badge bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full text-xs">delivery</span></td>
                <td class="p-3">Santos, Anna</td>
                <td class="p-3">4 items</td>
                <td class="p-3 font-medium">₱1,250</td>
                <td class="p-3"><span class="status-badge bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full text-xs">preparing</span></td>
                <td class="p-3">
                  <button onclick="viewOrder('OR1004')" class="text-amber-700 text-xs hover:underline mr-2">view</button>
                  <button onclick="updateOrderStatus('OR1004', 'ready')" class="text-green-600 text-xs hover:underline">ready</button>
                </td>
              </tr>
              <tr data-order-id="OR1005" data-type="takeout" data-status="preparing">
                ...
                <td class="p-3"><span class="status-badge bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full text-xs">preparing</span></td>
                <td class="p-3">
                  <button onclick="viewOrder('OR1005')" class="text-amber-700 text-xs hover:underline mr-2">view</button>
                  <button onclick="updateOrderStatus('OR1005', 'ready')" class="text-green-600 text-xs hover:underline">ready</button>
                </td>
              </tr>
              <tr data-order-id="OR1006" data-type="dine-in" data-status="preparing">
                ...
                <td class="p-3"><span class="status-badge bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full text-xs">preparing</span></td>
                <td class="p-3">
                  <button onclick="viewOrder('OR1006')" class="text-amber-700 text-xs hover:underline mr-2">view</button>
                  <button onclick="updateOrderStatus('OR1006', 'ready')" class="text-green-600 text-xs hover:underline">ready</button>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-2xl p-5">
          <div class="flex justify-between items-center mb-3">
            ...
            <a href="../restaurant_management/kitchen_orders.html" class="text-xs text-amber-600 hover:underline">view full kitchen display →</a>
          </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-2xl p-5">
          ...
          <div class="mt-4 pt-3 border-t border-green-200">
            <span class="text-xs text-green-700"><span class="font-semibold" id="readyCount">1</span> order waiting</span>
          </div>
        </div>
      </div>
    </main>
