              ...
              <tbody class="divide-y" id="tableBody">
                ...
                <?php else: ?>
                  <?php foreach ($reservations as $res):
                    ...
                    ?>
                    <tr data-id="<?php echo $res['id']; ?>" data-status="<?php echo $res['status']; ?>"
                      ...
                      <td class="p-3">
                        ...
                        ?>
                        <span
                          class="<?php echo $dateClass; ?>"><?php echo date('M d, Y', strtotime($res['reservation_date'])); ?></span>
                      </td>
                      <td class="p-3">
                      ...
                      <td class="p-3 font-medium">
                        <div class="flex items-center gap-1">
                          ...
                          <?php if ($res['member_tier'] && $res['member_tier'] !== 'bronze'): ?>
                            <i class="fas fa-gem text-amber-500"
                              title="<?php echo ucfirst($res['member_tier']); ?> member"></i>
                          <?php endif; ?>
                        </div>
                      </td>
                      ...
                      <td class="p-3">
                        ...
                        <?php if ($res['down_payment'] > 0): ?>
                          <span
                            class="text-xs text-amber-600 block mt-1">₱<?php echo number_format($res['down_payment']); ?></span>
                        <?php endif; ?>
                      </td>
                      <td class="p-3">
                        <?php if ($res['points_earned'] > 0): ?>
                          <span
                            class="text-xs font-medium <?php echo $res['points_awarded'] ? 'text-green-600' : 'text-amber-600'; ?>">
            ...
            <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3" id="tableGrid">
              <?php foreach ($tables as $table):
                ...
                <div class="table-tile border rounded-lg p-2 text-center <?php echo $colorClass; ?>"
                  data-table="<?php echo $table['table_number']; ?>" data-status="<?php echo $table['status']; ?>"
