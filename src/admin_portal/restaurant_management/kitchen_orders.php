    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
      ...
      <main class="flex-1 p-5 lg:p-8 overflow-y-auto bg-white">
        ...
        <div class="flex flex-wrap gap-2 border-b border-slate-200 pb-2 mb-6">
          <button id="filterAll" class="filter-btn px-4 py-2 bg-amber-600 text-white rounded-full text-sm">all
            orders</button>
          <button id="filterNew"
            class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">new</button>
          <button id="filterPreparing"
            class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">preparing</button>
          <button id="filterReady"
            class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">ready</button>
          <button id="filterUrgent"
            class="filter-btn px-4 py-2 bg-white border border-slate-200 rounded-full text-sm hover:bg-slate-50">urgent</button>
        </div>
          ...
          <table class="min-w-full text-sm" id="ordersTable">
            ...
            <tbody class="divide-y divide-slate-100" id="ordersTableBody">
              ...
              <tr data-status="new" data-order-id="KOT-1001">
                ...
                <td class="px-5 py-3"><span class="bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded-full">NEW</span>
                </td>
                <td class="px-5 py-3">12:30 PM</td>
                <td class="px-5 py-3">no onions, extra spicy</td>
                <td class="px-5 py-3">
                  <button class="edit-btn text-amber-600 hover:text-amber-800" onclick="openEditModal('KOT-1001')"><i
              ...
              <tr data-status="preparing" data-order-id="KOT-1002">
                ...
                <td class="px-5 py-3"><span
                    class="bg-amber-100 text-amber-700 text-xs px-2 py-1 rounded-full">PREPARING</span></td>
                <td class="px-5 py-3">12:45 PM</td>
                <td class="px-5 py-3">—</td>
                <td class="px-5 py-3">
                  <button class="edit-btn text-amber-600 hover:text-amber-800" onclick="openEditModal('KOT-1002')"><i
                      class="fa-regular fa-pen-to-square"></i></button>
                </td>
              </tr>
              <!-- Order 3: Urgent -->
              <tr data-status="urgent" data-order-id="KOT-1003">
                ...
                <td class="px-5 py-3"><span class="bg-red-100 text-red-700 text-xs px-2 py-1 rounded-full">URGENT</span>
                </td>
                <td class="px-5 py-3">1:00 PM</td>
                <td class="px-5 py-3">well-done crispy pata</td>
                <td class="px-5 py-3">
                  <button class="edit-btn text-amber-600 hover:text-amber-800" onclick="openEditModal('KOT-1003')"><i
                      class="fa-regular fa-pen-to-square"></i></button>
                </td>
              </tr>
              <!-- Order 4: Preparing -->
              <tr data-status="preparing" data-order-id="KOT-1004">
                ...
                <td class="px-5 py-3">
                  <button class="edit-btn text-amber-600 hover:text-amber-800" onclick="openEditModal('KOT-1004')"><i
                      class="fa-regular fa-pen-to-square"></i></button>
                </td>
              </tr>
              <!-- Order 5: New -->
              <tr data-status="new" data-order-id="KOT-1005">
                ...
                <td class="px-5 py-3">—</td>
                <td class="px-5 py-3">
                  <button class="edit-btn text-amber-600 hover:text-amber-800" onclick="openEditModal('KOT-1005')"><i
                      class="fa-regular fa-pen-to-square"></i></button>
                </td>
              </tr>
              <!-- Order 6: Ready -->
              <tr data-status="ready" data-order-id="KOT-1006">
                ...
                <td class="px-5 py-3"><span
                    class="bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full">READY</span></td>
                <td class="px-5 py-3">1:45 PM</td>
                <td class="px-5 py-3">—</td>
                <td class="px-5 py-3">
                  <button class="edit-btn text-amber-600 hover:text-amber-800" onclick="openEditModal('KOT-1006')"><i
                      class="fa-regular fa-pen-to-square"></i></button>
                </td>
              </tr>
            </tbody>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6">
          <h2 class="font-semibold text-lg flex items-center gap-2 mb-4"><i
              class="fa-regular fa-rectangle-list text-amber-600"></i> preparation queue</h2>
              ...
              <tbody class="divide-y divide-slate-100" id="queueTableBody">
                <tr class="hover:bg-slate-50" data-queue-status="new">
                  ...
                  <td class="px-4 py-3"><span
                      class="bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded-full">NEW</span></td>
                ...
                <tr class="hover:bg-slate-50" data-queue-status="urgent">
                  ...
                  <td class="px-4 py-3"><span
                      class="bg-red-100 text-red-700 text-xs px-2 py-1 rounded-full">URGENT</span></td>
