              ...
              <?php else: ?>
                <?php foreach ($kitchenOrders as $order):
                  ...
                  <tr data-status="<?php echo $order['status']; ?>"
                    data-order-id="<?php echo $order['order_reference']; ?>">
                    ...
                    <td class="px-5 py-3">
                      <span
                        class="status-badge <?php echo $statusColor; ?> text-xs px-2 py-1 rounded-full"><?php echo $statusDisplay; ?></span>
                    </td>
                    ...
                    <td class="px-5 py-3">
                      <button class="edit-btn text-amber-600 hover:text-amber-800 mr-2"
                        onclick="openEditModal('<?php echo $order['order_reference']; ?>')" title="Edit">
                        <i class="fas fa-pen-to-square"></i>
                      </button>
                      <?php if ($order['status'] !== 'urgent'): ?>
                        <button class="urgent-btn text-red-600 hover:text-red-800"
                          onclick="markAsUrgent('<?php echo $order['order_reference']; ?>')" title="Mark Urgent">
                ...
                <?php else: ?>
                  <?php foreach ($prepQueue as $item):
                    ...
                    <tr class="hover:bg-slate-50" data-queue-status="<?php echo $item['status']; ?>"
                      ...
                      <td class="px-4 py-3">
                        <span
                          class="<?php echo $statusColor; ?> text-xs px-2 py-1 rounded-full"><?php echo $statusDisplay; ?></span>
                      </td>
                      ...
                      <td class="px-4 py-3">
                        <button class="text-amber-600 hover:text-amber-800"
                          onclick="openEditModal('<?php echo $item['order_reference']; ?>')">
                          <i class="fas fa-pen-to-square"></i>
                        </button>
                      </td>
                    </tr>
