        ...
        <div class="flex items-center gap-3 px-6 py-5 border-b border-slate-100 bg-slate-50/80">
          ...
          <div>
            ...
            <p class="text-xs text-slate-500 flex items-center gap-1"><i class="fa-regular fa-gem text-[11px]"></i>
              <span id="loyaltyTier">—</span> · <span id="points">0</span> pts</p>
          </div>
        </div>
          ...
          <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <div class="space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div><label class="block text-xs text-slate-500 mb-1">First name <span
                      class="required-asterisk">*</span></label><input type="text" id="firstName"
                    placeholder="e.g. Maria" value="" class="w-full border p-3 rounded-xl"></div>
                <div><label class="block text-xs text-slate-500 mb-1">Last name <span
                      class="required-asterisk">*</span></label><input type="text" id="lastName"
                    placeholder="e.g. Santos" value="" class="w-full border p-3 rounded-xl"></div>
              </div>
              <div><label class="block text-xs text-slate-500 mb-1">Email <span
                    class="required-asterisk">*</span></label><input type="email" id="email"
                  placeholder="name@example.com" value="" class="w-full border p-3 rounded-xl"></div>
              <div><label class="block text-xs text-slate-500 mb-1">Phone <span
                    class="required-asterisk">*</span></label><input type="tel" id="phone"
                  placeholder="+63 912 345 6789" value="" class="w-full border p-3 rounded-xl"></div>
              <div class="grid grid-cols-2 gap-4">
                <div><label class="block text-xs text-slate-500 mb-1">Check-in</label><input type="date"
                    id="step1Checkin" value="" class="w-full border p-3 rounded-xl"></div>
                <div><label class="block text-xs text-slate-500 mb-1">Check-out</label><input type="date"
                    id="step1Checkout" value="" class="w-full border p-3 rounded-xl"></div>
              </div>
              <div><label class="block text-xs text-slate-500 mb-1">Guests</label><select id="step1Guests"
              ...
              <div class="flex justify-end">
                <button onclick="validateStep1()" class="btn btn-primary">Continue to room selection <i
        ...
        <div id="step2-content" class="hidden">
          <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <div class="flex gap-3 mt-6">
              <button onclick="attemptBackToStep(1)" class="flex-1 btn btn-outline"><i
                  class="fa-regular fa-arrow-left"></i> Back</button>
              <button onclick="proceedToPayment()" class="flex-1 btn btn-primary">Proceed to payment <i
