          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap4" id="menuGrid">
              ...
              <div
                ...
                data-category="mains" data-name="Sinigang na Baboy" data-price="320">
              ...
              <div
                class="menu-item bg-white rounded-2xl border border-slate-200 p-4 flex gap-3 hover:shadow-md transition"
                data-category="mains" data-name="Sizzling Sisig" data-price="290">
                <div class="h-20 w-20 bg-slate-200 rounded-xl shrink-0 flex items-center justify-center text-slate-400">
                  <i class="fa-regular fa-image"></i></div>
                <div class="flex-1">
                  <div class="flex items-start justify-between">
              ...
              <div
                class="menu-item bg-white rounded-2xl border border-slate-200 p-4 flex gap-3 hover:shadow-md transition"
                data-category="mains" data-name="Crispy Pata" data-price="550">
                <div class="h-20 w-20 bg-slate-200 rounded-xl shrink-0 flex items-center justify-center text-slate-400">
                  <i class="fa-regular fa-image"></i></div>
                <div class="flex-1">
                  <div class="flex items-start justify-between">
              ...
              <div
                class="menu-item bg-white rounded-2xl border border-slate-200 p-4 flex gap-3 hover:shadow-md transition"
                data-category="desserts" data-name="Halo-Halo" data-price="150">
                <div class="h-20 w-20 bg-slate-200 rounded-xl shrink-0 flex items-center justify-center text-slate-400">
                  <i class="fa-regular fa-image"></i></div>
                <div class="flex-1">
                  <div class="flex items-start justify-between">
              ...
              <div
                class="menu-item bg-white rounded-2xl border border-slate-200 p-4 flex gap-3 hover:shadow-md transition"
                data-category="beverages" data-name="Fresh Buko Juice" data-price="90">
                <div class="h-20 w-20 bg-slate-200 rounded-xl shrink-0 flex items-center justify-center text-slate-400">
                  <i class="fa-regular fa-image"></i></div>
                <div class="flex-1">
                  <div class="flex items-start justify-between">
              ...
              <div
                class="menu-item bg-white rounded-2xl border border-slate-200 p-4 flex gap-3 hover:shadow-md transition"
                data-category="mains" data-name="Garlic Rice" data-price="50">
                <div class="h-20 w-20 bg-slate-200 rounded-xl shrink-0 flex items-center justify-center text-slate-400">
                  <i class="fa-regular fa-image"></i></div>
                <div class="flex-1">
                  <div class="flex items-start justify-between">
